            ...
            <section>
                ...
                <template>
                    ...
                    <el-table :data="tableData" highlight-current-row v-loading="listLoading" style="width: 100%; height:100%">
                        ...
                        <el-table-column prop="UserHeadImg" label="头像" width="90">
                            <template slot-scope="scope">
                                <img :src="scope.row.UserHeadImg" alt="头像" style="width:50px;height:50px">
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="UserAge" label="年龄" sortable>
                        </el-table-column>

                        <el-table-column prop="UserPhoneNum" label="手机号">
                        </el-table-column>

                        <el-table-column prop="UserBirth" label="生日" :formatter="formatDate">
                        </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            handleEdit: function (row) {
                ...
                this.editForm.UserBirth = row.UserBirth;
                this.editForm.UserAddr = row.UserAddr;
                ...
                _this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        _this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            var userData = {
                                name: _this.editForm.UserName,
                                sex: _this.editForm.UserSex,
                                age: _this.editForm.UserAge,
                                birth: _this.editForm.UserBirth == '' ? '' : util.formatDate.format(new Date(_this.editForm.UserBirth), 'yyyy-MM-dd'),
                                addr: _this.editForm.UserAddr,
                                phonenum: _this.editForm.UserPhoneNum
                            }
