          ...
          <el-col :span="8">
            <el-card class="box-card" :body-style="{ padding: '0px' }">
              ...
              <el-menu :default-active="default_active" @select="handleselect" >
                <el-menu-item v-for="i in proj_data" >{{i.label}}</el-menu-item>
              </el-menu>
            </el-card>
          </el-col>

          <el-col :span="16">
            <el-table border fit stripe :data="tableDeviceData" highlight-current-row v-loading="listLoading" style="width: 100%; height:100%">
